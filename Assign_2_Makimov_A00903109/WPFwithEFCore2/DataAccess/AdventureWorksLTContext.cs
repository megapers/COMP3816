...
namespace DataAccess
{
    public partial class AdventureWorksLTContext : DbContext
    {
        ...
        public virtual DbSet<Employee> Empolyees { get; set; }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-5MGN125;Initial Catalog=AdventureWorksLT; integrated security=True;");
            }
        }
